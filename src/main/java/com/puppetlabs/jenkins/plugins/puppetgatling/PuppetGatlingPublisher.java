...
import com.puppetlabs.jenkins.plugins.puppetgatling.gatling.NodeSimulationData;
...
//        Map stats = (Map) engine.get("stats");
    ...
    private SimulationReport generateSimulationReport(
        ...
        FilePath simConfigDataPath = new FilePath(workspace, "puppet-gatling/" + simID + "/gatling_sim_data.csv");
        String simConfigDataString = IOUtils.toString(simConfigDataPath.read(), "UTF-8");
        simReport.setSimConfigDataString(simConfigDataString);
